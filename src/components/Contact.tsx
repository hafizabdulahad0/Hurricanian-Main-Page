          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8">
            ...
            <div className="flex justify-center items-center space-x-6">
              ...
              <div className="relative group">
                <a href="https://api.whatsapp.com/send?phone=+112067101079&text=Hello%20Hurricanian" aria-label="WhatsApp" className="social-icon" target="_blank" rel="noopener noreferrer">
              ...
              {/* Facebook */}
              <div className="relative group">
                <a href="https://www.facebook.com/hurricaniangroup" aria-label="Facebook" className="social-icon" target="_blank" rel="noopener noreferrer">
              ...
              {/* Instagram */}
              <div className="relative group">
                <a href="https://www.instagram.com/hurricaniangroup" aria-label="Instagram" className="social-icon" target="_blank" rel="noopener noreferrer">
