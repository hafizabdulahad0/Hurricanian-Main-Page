          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700 dark:text-gray-300">contact@hurricanian.com</span>
              </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8">
            ...
            <div className="flex justify-center items-center space-x-6">
              ...
              <div className="relative group">
                <a
                  href="https://api.whatsapp.com/send?phone=+112067101079&text=Hello%20Hurricanian"
                  aria-label="WhatsApp"
                ...
                <div className="absolute top-[-40px] left-1/2 transform -translate-x-1/2 bg-green-700 text-white py-1 px-3 rounded opacity-0 invisible transition-all duration-300 group-hover:opacity-100 group-hover:visible group-hover:top-[-40px]">WhatsApp</div>
              </div>
              
              {/* Facebook */}
              <div className="relative group">
                <a
                  href="https://www.facebook.com/hurricaniangroup"
                  aria-label="Facebook"
                  className="social-icon"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <div className="absolute top-[-40px] left-1/2 transform -translate-x-1/2 bg-green-700 text-white py-1 px-3 rounded opacity-0 invisible transition-all duration-300 group-hover:opacity-100 group-hover:visible group-hover:top-[-40px]">Facebook</div>
              </div>
              
              {/* Instagram */}
              <div className="relative group">
                <a
                  href="https://www.instagram.com/hurricaniangroup"
                ...
                <div className="absolute top-[-40px] left-1/2 transform -translate-x-1/2 bg-green-700 text-white py-1 px-3 rounded opacity-0 invisible transition-all duration-300 group-hover:opacity-100 group-hover:visible group-hover:top-[-40px]">Instagram</div>
              </div>
            </div>
          </div>
        </div>
